          ...
          >
            ...
            <View>
              ...
              <Text
                style={{ color: "white", fontSize: 18, fontWeight: "bold" }}
              >
                {Math.floor((todayProgress.timeSpent || 0) / 60)}m
              </Text>
            </View>
          </View>
        </View>
      ...
      {stats && (
        ...
        >
          ...
          >
            ...
            >
              <Ionicons name="language" size={20} color="#f97316" />
              <Text
                style={{
                  color: colors.text,
                  fontSize: 14,
            ...
            >
              {stats?.availableTranslations?.bn +
                stats?.availableTranslations?.en || 0}
            </Text>
          </View>
          ...
          >
            ...
            >
              <MaterialIcons name="school" size={20} color="#14b8a6" />
              <Text
                style={{
                  color: colors.text,
                  fontSize: 14,
            ...
            >
              {stats?.availableTafsir?.bn + stats?.availableTafsir?.en || 0}
            </Text>
          </View>
        </View>
      )}
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                {t(`common.${sura.revelation_place?.toLowerCase()}`)}
              </Text>
            </View>
            <Ionicons
