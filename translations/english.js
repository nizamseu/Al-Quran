export const english = {
  ...
  drawer: {
    about: "About",
    aboutText:
      "Experience the divine words of Allah with beautiful recitation and translation.",
  },

  // Home Screen
  home: {
    welcome: {
      title: "Welcome to Al-Quran",
    ...
    quickActions: {
      ...
      savedSuras: "saved suras",
      prayerTimes: "Prayer Times",
      todaySchedule: "Today's schedule",
      duas: "Duas",
      dailySupplications: "Daily supplications",
      search: "Search",
      findVerses: "Find verses & suras",
    ...
    recentActivity: {
      ...
      lastRead: "Last Read",
      lastReadDetails: "Surah Al-Fatiha - Verse 7",
      bookmarked: "Bookmarked",
      bookmarkedDetails: "3 verses saved today",
    },
    dailyVerse: {
  ...
  suraList: {
    title: "Sura List",
    searchPlaceholder: "Search suras...",
    totalSuras: "Total Suras",
    totalVerses: "Total Verses",
    allSuras: "All Suras",
  ...
  suraDetail: {
    ...
    modes: {
      ...
      tafsir: "Tafsir Only",
      both: "Translation & Tafsir",
    },
    loadError: "Failed to load sura data",
    playError: "Failed to play audio",
    notFound: "Sura not found",
  ...
  settings: {
    ...
    profile: {
      ...
      progress: "Reading progress: 12 Suras completed",
    },
    footer: {
      description:
        "Experience the divine words of Allah with beautiful recitation, translation, and spiritual guidance.",
    },
  },
